...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(20, 24)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = [55, 56, 57, 58, 59, 60, 61]
    actual = make_simple_list(55, 61)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(20, 25)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        upper_right = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
        lower_left = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        rectangleList = rectangleList + [rg.Rectangle(upper_right, lower_left)]
